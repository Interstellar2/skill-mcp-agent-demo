...
async def route_execution(mode: str, skill_name: str, variables: dict, model: str):
    """路由到对应的执行器."""
...
async def route_resume_rollback(args) -> bool:
    ...
    if args.resume:
        ...
        await resume_run(run_id=args.resume)
        return True
    ...
    if args.rollback:
        ...
        await rollback_run(run_id=args.rollback, to_step=args.to_step)
        return True
